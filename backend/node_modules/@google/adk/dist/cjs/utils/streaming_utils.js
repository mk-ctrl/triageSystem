  ...
  close() {
    ...
    if (this.isProgressiveMode) {
      ...
      return {
        ...
        errorMessage: finishReason === import_genai.FinishReason.STOP ? void 0 : candidate.finishMessage,
