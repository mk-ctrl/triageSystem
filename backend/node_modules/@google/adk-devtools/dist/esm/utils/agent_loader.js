 ...
 */
import { isBaseAgent } from "@google/adk";
  ...
  async load() {
    ...
    if (jsModule) {
      ...
      const rootAgents = Object.values(jsModule).filter(
        (exportValue) => isBaseAgent(exportValue)
      );
